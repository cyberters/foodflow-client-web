            ...
            {userData?.userProfile ? <>
                ...
                {/* <ListBox>
                    ...
                    <ListBoxItem label="Utwórz profil">
                        <div className="grid grid-cols-3 gap-2 lg:gap-4 pb-1">
                            <div className="col-span-3 lg:col-span-2 flex flex-col space-y-4">
                                <h3 className="text-xl lg:text-2xl">Witaj w food.flow – stwórz swój profil i działaj!</h3>
                                <span className="w-4/5">Wierzymy, że gotowanie może być nie tylko obowiązkiem, ale też źródłem radości, kreatywności i satysfakcji – dlatego jesteśmy tutaj, aby dzielić się pomysłami, ułatwiać kulinarne eksperymenty i wspólnie odkrywać, jak wiele przyjemności może kryć się w domowej kuchni.</span>
                            ...
                            <div className="hidden lg:block col-span-3 lg:col-span-1">
                                <img src={foodFlow002} alt="" srcSet="" className="ms-auto w-[45vw]"/>
                            </div>
                        </div>
                    </ListBoxItem>
                </ListBox>}
