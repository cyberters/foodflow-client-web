...
const FooterPage: React.FC = () => {
  return (
    <footer className="border border-black border-solid rounded-md px-4 py-3">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 lg:divide-x divide-y lg:divide-y-0 divide-dashed divide-brand-warm">
        ...
        <div className="lg:pl-3 pt-3 lg:pt-0">
          ...
          <div className="flex space-x-4 text-xl">
            <a href="https://www.linkedin.com/company/food-flow-ai"><FontAwesomeIcon icon={faLinkedin} /></a>
